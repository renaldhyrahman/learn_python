...
class Game:
    ...
    def keybind(self):
        ...
        self.screen.onkeypress(
            key="Right", fun=lambda: self.head_direction("e")
        )
        self.screen.onkeypress(key="Up", fun=lambda: self.head_direction("n"))
        self.screen.onkeypress(
            key="Left", fun=lambda: self.head_direction("w")
        )
        self.screen.onkeypress(
            key="Down", fun=lambda: self.head_direction("s")
        )
