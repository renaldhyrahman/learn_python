    ...
    def display_input(input_list):
        ...
        if accept:
            while input_user not in accept + reject:
                ...
                if input_user in accept: return True
        else: input(question)
        return False
        ...
        try:
            match task:
                ...
                case "compare":
                    ...
                    print(f"\nCompare A: "
                          f"{question_1['name']}, a {question_1['description']}, from {question_1['country']}.")
                    print(f"{ASCII_VS}")
                    print(f"Against B:"
                          f" {question_2['name']}, a {question_2['description']}, from {question_2['country']}.\n")
        except TypeError:
