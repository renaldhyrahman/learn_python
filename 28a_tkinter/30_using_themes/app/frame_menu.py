...
class Menu(ttk.Frame):
    ...
    def build_layout(self):
        ...
        self.button1.grid(
            row=0, column=0, sticky="nswe", columnspan=2, padx=4, pady=4
        )
        self.button2.grid(row=0, column=2, sticky="nswe", padx=4, pady=4)
        self.button3.grid(
            row=1, column=0, sticky="nswe", columnspan=3, padx=4, pady=4
        )
